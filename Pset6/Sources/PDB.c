 ...
 * 
 * count is the number of 1/9375 second time periods
...
void PDB0Init(uint16_t count, int continuous) {
	 ...
	 * frequency of 16384 Hz */
	  ...
	  /* Alternatively, after mcgInit is called, the peripheral clock
	     * runs at 12 MHz. With the output divider set to 10 (by mcgInit)
	     * Setting the prescaler to divide by (128 * 10)
	     * yields a counter frequency of 9375 Hz
	     */
	 ...
	 * PDB interrupt enabled, Multiplication factor is 10,
